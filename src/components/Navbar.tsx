      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-2.5 group">
            ...
            <div>
              <span className="font-display font-semibold text-[#e0e7e0] group-hover:text-emerald-400 transition tracking-wide text-base block">
            ...
            {navLinks.map((link) => {
              ...
              return (
                <Link
                  key={link.path}
                  to={link.path}
                  className={`relative px-4 py-2 rounded-lg text-xs font-semibold tracking-wide transition ${
                    isActive
                      ? "text-emerald-400"
